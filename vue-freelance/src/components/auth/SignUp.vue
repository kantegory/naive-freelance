  ...
  <div class="w-50 border rounded p-3 mx-auto">
    <b-form @submit="register">
      <div class="form-group">
        ...
        <b-input v-model="username" type="text" id="username" placeholder="Логин..." autocomplete="off"></b-input>
      </div>
      <div class="form-group">
        <label for="phone">Номер телефона:</label>
        <b-input v-model="phone" type="text" id="phone" placeholder="+7 (921) 123 45 67" autocomplete="off"></b-input>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <b-input v-model="password" type="password" id="password" placeholder="Пароль..." autocomplete="off"></b-input>
      </div>
      <div class="form-group">
        <label for="repeatPassword">Повторите пароль:</label>
        <b-input v-model="repeatPassword" type="password" id="repeatPassword" placeholder="Повторите пароль..." autocomplete="off"></b-input>
      </div>
